...
execute if block ~ ~ ~ air positioned ~ ~-1.35 ~ unless entity @e[distance=..0.75,type=!armor_stand,type=!item,type=!item_frame,type=!player] positioned ^-0.1 ^ ^1 positioned ~ ~1.35 ~ run function colorator:red_shotgun_raycast/r_shot_blue_partical
